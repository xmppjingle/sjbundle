...
public interface SessionDescription extends Serializable, Cloneable {
     ...
     */
    public List getEmails(boolean create)
            throws SdpParseException;
     ...
     * @throws SdpException
     */
    public List getPhones(boolean create)
            throws SdpException;
     ...
     * @throws SdpException
     */
    public List getTimeDescriptions(boolean create)
            throws SdpException;
     ...
     * @throws SdpException if the List is null
     */
    public void setTimeDescriptions(List times)
            throws SdpException;
     ...
     * @throws SdpException
     */
    public List getZoneAdjustments(boolean create)
            throws SdpException;
     ...
     * @throws SdpException if the List is null
     */
    public void setZoneAdjustments(List zoneAdjustments)
            throws SdpException;
    ...
    /**
     * Returns the set of attributes for this Description as a List of Attribute
     * objects in the
     ...
     * @throws SdpException
     */
    public List getMediaDescriptions(boolean create)
            throws SdpException;
