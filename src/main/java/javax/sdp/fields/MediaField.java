...
public class MediaField extends SDPField implements Media {
     ...
     * @throws SdpException
     */
    public List getMediaFormats(boolean create) throws SdpParseException {
     ...
     */
    public void setMediaFormats(List mediaFormats) throws SdpException {
    ...
    public Object clone() {
        ...
        if (this.formats != null) {
            retval.formats = new ArrayList();
            Collections.copy(retval.formats, this.formats);
        }
        return retval;
    }
}
