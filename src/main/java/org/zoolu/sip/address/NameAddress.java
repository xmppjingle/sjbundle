...
public class NameAddress {
    ...
    /**
     * Gets bare address of NameAddress
     *
     * @return
     */
    public SipURL getBareAddress() {
        return new SipURL(url.getUserName(), url.getHost());
    }
    ...
    public String toString() {
        String str;
        if (hasDisplayName()) {
            str = new StringBuilder().append("\"").append(name).append("\" <").append(url).append(">").toString();
        } else {
            str = "<" + url + ">";
        }
