...
public abstract class EndPointHeader extends NameAddressHeader {
     ...
     */
    static final String[] ENDPOINTPARAMS = {"tag", "expires"};
    ...
    public NameAddress getNameAddress() {
        ...
        for (String aENDPOINT_PARAMS : ENDPOINTPARAMS) {
            if (url.hasParameter(aENDPOINT_PARAMS)) {
                url.removeParameter(aENDPOINT_PARAMS);
